...
export default {
  ...
  getUser({
    ...
    return http.get(
      `/admin/allUser?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 添加用户
  addUser({
  ...
  getBanner({
    ...
    return http.get(
      `/admin/getBanner?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 新增轮播图
  addBanner({
  ...
  getNotice({
    ...
    return http.get(
      `/admin/getNotice?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 新增通知
  ...
  getNav({
    ...
    return http.get(
      `/admin/getNav?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 新增导航
  ...
  getRecommendNav({
    ...
    return http.get(
      `/admin/getIndexNav?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 新增导航
  addRecommendNav({
  ...
  getModel({
    ...
    return http.get(
      `/admin/getModel?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  //   删除
  delModel(id: string) {
  ...
  getCategory(query: string) {
    return http.get(
      `/admin/getCategory?current=1&pageSize=10000&query=${query}`,
    );
  },
  // 添加一级分类
  addCategory({
  ...
  getGoods({
    ...
    return http.get(
      `/admin/getGoods?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 删除
  delGoods(id: string) {
  ...
  getSeckill({
    ...
    return http.get(
      `/admin/getSeckill?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  // 添加秒杀
  addSeckill({
  ...
  getCoupon({
    ...
    return http.get(
      `/admin/getCoupon?current=${current}&pageSize=${pageSize}&query=${query}`,
    );
  },
  addCoupon({
    name,
