...
// 定义state的数据
export interface AddgoodsModelState {
  topics: any[];
  data: any[];
  obj: any[];
}

export interface AddgoodsModelType {
  namespace: 'addgoods';
  state: AddgoodsModelState;
  ...
  // 等同于vuex里面的mutation
  reducers: {
    setTopics: Reducer<AddgoodsModelState>;
    setdata: Reducer<AddgoodsModelState>;
    setobj: Reducer<AddgoodsModelState>;
  };
}

const AddgoodsModel: AddgoodsModelType = {
  namespace: 'addgoods',
  state: {
    topics: [],
    data: [],
