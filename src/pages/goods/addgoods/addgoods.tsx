...
const Addgoods = () => {
  ...
  let columns: any = [
    ...
    },
    {
      ...
      key: '_id',
      align: 'center',
      render: (isNewGood: boolean, _id: any) => (
    ...
    },
    {
      ...
      key: '_id',
      align: 'center',
      render: (isHot: boolean, _id: any) => <div>{isHot ? '是' : '否'}</div>,
    },
    {
      title: '是否推荐',
      ...
      key: '_id',
      align: 'center',
      render: (isRecommend: boolean, _id: any) => (
  ...
  let onShowSizeChange = (current1: number, pageSize1?: number) => {
    ...
    dispatch({
      type: 'addgoods/getdata',
      payload: { current: current1, pageSize: pageSize1, query: '' },
    });
  };
  return (
