...
import AddRotation from '@/components/slideshow/addRotation';
import EditRotation from '@/components/slideshow/editRotation';

// 轮播图管理
const Slideshow = () => {
  let list = useSelector((state: any) => state.slideshow.data);
