...
// 定义state的数据
export interface SlideshowModelState {
  topics: any[];
  data: any[];
}

export interface SlideshowModelType {
  namespace: 'slideshow';
  state: SlideshowModelState;
  ...
  // 等同于vuex里面的mutation
  reducers: {
    setTopics: Reducer<SlideshowModelState>;
    setdata: Reducer<SlideshowModelState>;
  };
}

const SlideshowModel: SlideshowModelType = {
  namespace: 'slideshow',
  state: {
    topics: [],
    data: [],
