...
import AddRotation from '@/components/navigation/add';
import EditRotation from '@/components/navigation/edit';

// 导航管理
const Navigation = () => {
  let list = useSelector((state: any) => state.navigation.data);
