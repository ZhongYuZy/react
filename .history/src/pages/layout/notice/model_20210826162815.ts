...
// 定义state的数据
export interface InformModelState {
  topics: any[];
  data: any[];
}

export interface InformModelType {
  namespace: 'Notice';
  state: InformModelState;
  ...
  // 等同于vuex里面的mutation
  reducers: {
    setTopics: Reducer<InformModelState>;
    setdata: Reducer<InformModelState>;
  };
}

const InformModel: InformModelType = {
  namespace: 'Notice',
  state: {
    topics: [],
    data: [],
